...
--
-- Servidor: localhost
-- Data Criação: 19-07-2021 a las 21:20:00
...
--
-- Estrutura de tabela para a tabela `avatar`
--
...
--
-- Carga de dados para a tabela `avatar`
--

INSERT INTO `avatar` (`idAvatar`, `nome`, `urlimagem`) VALUES
...
--
-- Estrutura de tabela para a tabela `canal`
--
...
--
-- Carga de dados para a tabela`canal`
--

INSERT INTO `canal` (`idCanal`, `nome`, `descricao`, `dataCriacao`, `usuario_idUsuario`) VALUES
...
--
-- Estrutura de tabela para a tabela `hashtag`
--
...
--
-- Carga de dados para a tabela`hashtag`
--

INSERT INTO `hashtag` (`idHashtag`, `nome`) VALUES
(1, 'Mark Ronson'),
(2, 'vevo'),
(3, 'official'),
(4, 'video'),
...
--
-- Estrutura de tabela para a tabela `pais`
--
...
--
-- Carga de dados para a tabela`pais`
--
...
--
-- Estrutura de tabela para a tabela `playlist`
--
...
--
-- Carga de dados para a tabela`playlist`
--

INSERT INTO `playlist` (`idPlaylist`, `nome`, `dataCriacao`, `privado`, `usuario_idUsuario`) VALUES
...
--
-- Estrutura de tabela para a tabela `playlist_video`
--
...
--
-- Carga de dados para a tabela`playlist_video`
--
...
--
-- Estrutura de tabela para a tabela `reacao`
--
...
CREATE TABLE IF NOT EXISTS `reacao` (
  ...
  `Tiporeacao_idTiporeacao` int(11) NOT NULL,
  `usuario_idUsuario` int(11) NOT NULL,
  `video_idVideo` int(11) NOT NULL,
  PRIMARY KEY (`idreacao`),
  KEY `fk_reacao_Tiporeacao1_idx` (`Tiporeacao_idTiporeacao`),
  KEY `fk_reacao_Usuario1_idx` (`usuario_idUsuario`),
  KEY `fk_reacao_Video1_idx` (`video_idVideo`)
) ENGINE=InnoDB AUTO_INCREMENT=92 DEFAULT CHARSET=utf8;

--
-- Carga de dados para a tabela`reacao`
--

INSERT INTO `reacao` (`idreacao`, `data`, `Tiporeacao_idTiporeacao`, `usuario_idUsuario`, `video_idVideo`) VALUES
...
--
-- Estrutura de tabela para a tabela `tiporeacao`
--

DROP TABLE IF EXISTS `tiporeacao`;
CREATE TABLE IF NOT EXISTS `tiporeacao` (
  `idTiporeacao` int(11) NOT NULL AUTO_INCREMENT,
  `nome` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idTiporeacao`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

--
-- Carga de dados para a tabela`tiporeacao`
--

INSERT INTO `tiporeacao` (`idTiporeacao`, `nome`) VALUES
(1, 'Like'),
(2, 'DisLike');
...
--
-- Estrutura de tabela para a tabela `usuario`
--
...
--
-- Carga de dados para a tabela`usuario`
--

INSERT INTO `usuario` (`idUsuario`, `nome`, `email`, `senha`, `dataNascimento`, `codigoPostal`, `Pais_idPais`, `Avatar_idAvatar`) VALUES
...
--
-- Estrutura de tabela para a tabela `video`
--
...
CREATE TABLE IF NOT EXISTS `video` (
  ...
  `qtdReproducoes` int(11) DEFAULT NULL,
  `qtdLikes` int(11) DEFAULT NULL,
  `qtdDislikes` int(11) DEFAULT NULL,
  `privado` smallint(6) DEFAULT NULL,
  `dtaPublicacao` datetime DEFAULT NULL,
  PRIMARY KEY (`idVideo`),
  KEY `fk_Video_Usuario1_idx` (`usuario_idUsuario`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8;

--
-- Carga de dados para a tabela`video`
--

INSERT INTO `video` (`idVideo`, `usuario_idUsuario`, `titulo`, `descricao`, `tamanho`, `nomeArquivo`, `duracao`, `imagem`, `qtdReproducoes`, `qtdLikes`, `qtdDislikes`, `privado`, `dtaPublicacao`) VALUES
...
--
-- Estrutura de tabela para a tabela `video_Hashtag`
--
...
CREATE TABLE IF NOT EXISTS `video_hashtag` (
  ...
  KEY `fk_Video-Hashtag_Video1_idx` (`video_idVideo`),
  KEY `fk_Video-Hashtag_Hashtag1_idx` (`hashtag_idHashtag`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Carga de dados para a tabela`video_Hashtag`
--

INSERT INTO `video_hashtag` (`video_idVideo`, `hashtag_idHashtag`) VALUES
(5, 80),
(1, 60),
(6, 73),
(14, 55),
...
--
-- Filtros para a tabela `reacao`
--
ALTER TABLE `reacao`
  ADD CONSTRAINT `fk_reacao_Tiporeacao1` FOREIGN KEY (`Tiporeacao_idTiporeacao`) REFERENCES `tiporeacao` (`idTiporeacao`),
  ADD CONSTRAINT `fk_reacao_Usuario1` FOREIGN KEY (`usuario_idUsuario`) REFERENCES `usuario` (`idUsuario`),
  ADD CONSTRAINT `fk_reacao_Video1` FOREIGN KEY (`video_idVideo`) REFERENCES `video` (`idVideo`);

--
-- Filtros para a tabela `usuario`
--
ALTER TABLE `usuario`
...
--
-- Filtros para a tabela `video`
--
ALTER TABLE `video`
  ADD CONSTRAINT `fk_Video_Usuario1` FOREIGN KEY (`usuario_idUsuario`) REFERENCES `usuario` (`idUsuario`);

--
-- Filtros para a tabela `video_hashtag`
--
ALTER TABLE `video_hashtag`
  ADD CONSTRAINT `fk_Video-Hashtag_Hashtag1` FOREIGN KEY (`hashtag_idHashtag`) REFERENCES `hashtag` (`idHashtag`),
  ADD CONSTRAINT `fk_Video-Hashtag_Video1` FOREIGN KEY (`video_idVideo`) REFERENCES `video` (`idVideo`);
COMMIT;
