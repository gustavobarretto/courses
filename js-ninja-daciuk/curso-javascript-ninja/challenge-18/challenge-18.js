(function () {
    ...
    */
    ...
    let expression = 'Os meses de janeiro, junho e julho começam com a letra j.'

    console.log(expression.match(/junho|julho/g));
    ...
    */
    ...
    let stringTags = '<div><section><blockquote>Texto <img /></blockquote></section></div>';

    console.log(stringTags.match(/\<\w+\>/g))
    ...
    */
    ...
    let emptyTags = '<div><ul><li></li><li></li><li><span></span></li></ul></div>';

    console.log(emptyTags.match(/<li><\/li>|<span><\/span>/g))
    ...
    */
    ...
    let captureText = '<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>'

    console.log(captureText.replace( /(<(\w+)>)([\w áéíóú]+)(<\/\w+>)/gm,
