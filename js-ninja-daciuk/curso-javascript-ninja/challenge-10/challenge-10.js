(function () {
        ...
        */
        ...
        console.log('Teste isOperatorValid')

        console.log(isOperatorValid('+'));

        console.log(isOperatorValid('R'));
        ...
        */
        ...
        function calculator (operator) {
                return isOperatorValid(operator) ? operation[operator] != NaN ? operation[operator] : false : false;
        }

        console.log('Teste calculator function: ')
        ...
        */
        ...
        let sum = calculator(operationSingal);
        ...
        */
        ...
        !!sum ? console.log(showOperationMessage(operationSingal, number1, number2), sum(number1, number2)) :
                console.log(showErrorMessage(operationSingal));
        ...
        */
        ...
        let subtraction = calculator(operationSingal);

        !!subtraction ? console.log(showOperationMessage(operationSingal, number1, number2), subtraction(number1, number2)) :
                console.log(showErrorMessage(operationSingal));

        operationSingal = '*';

        let multiplication = calculator(operationSingal);

        !!multiplication ? console.log(showOperationMessage(operationSingal, number1, number2), multiplication(number1, number2)) :
                console.log(showErrorMessage(operationSingal));

        operationSingal = '/';

        let division = calculator(operationSingal);

        !!division ? console.log(showOperationMessage(operationSingal, number1, number2), division(number1, number2)) :
                console.log(showErrorMessage(operationSingal));

        operationSingal = '%';

        let mod = calculator(operationSingal);

        !!mod ? console.log(showOperationMessage(operationSingal, number1, number2), mod(number1, number2)) :
                console.log(showErrorMessage(operationSingal));
        ...
        */
        ...
        mod = calculator(operationSingal);
